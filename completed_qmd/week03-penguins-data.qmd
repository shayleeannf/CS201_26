...
ggplot(data = penguins_data, aes(x = flipper_length_mm, fill = species)) +
  geom_histogram(alpha = 0.85) + #alpha changes transparancy
  scale_fill_manual(values = c("darkorange", "darkorchid", "cyan4"), name = "Species Type") + #entering the colors manually
  theme_bw() +
...
ggplot(data = penguins_data, aes(x = flipper_length_mm, fill = species)) +
  geom_histogram(alpha = 0.85) + #alpha changes transparancy
  scale_fill_viridis_d(option = "inferno", name = "Species Type") + #entering colors through viridis scale
  theme_bw() +
  labs(title = "Palmer Penguins' Flipper Length",
       subtitle = "Three species observed on three islands in the Palmer Archipelago",
       x = "Flipper Length (mm)",
...
ggplot(data = penguins_data, aes(x = species, y = flipper_length_mm, fill = species)) +
  ...
  theme_bw() +
  scale_fill_manual(values = c("darkorange", "darkorchid", "cyan4"), name = "Species Type") +
  labs(title = "Palmer Penguins' Flipper Length",
       subtitle = "Three species observed on three islands in the Palmer Archipelago",
       x = "Flipper Length (mm)",
       y = "Number of Penguins") +
  theme(axis.text.x = element_text(angle = 45, hjust = 1, vjust = 1), legend.position = "none") + #angles the names and changes the position of the words, legend "none" removes the legend
  coord_flip()
...
ggplot(data = penguins_data, aes(x = culmen_depth_mm, fill = species)) +
  ...
  labs(title = "Palmer Penguins' Culmen Depth",
       subtitle = "Three species observed on three islands in the Palmer Archipelago",
       x = "Culmen Depth (mm)",
       y = "Number of Penguins")
...
ggplot(data = penguins_data, aes(x = culmen_depth_mm, y = body_mass_g, color = species)) +
  ...
  labs(title = "Palmer Penguins' Culmen Depth Compared to Body Mass",
       subtitle = "Three species observed on three islands in the Palmer Archipelago",
       x = "Culmen Depth (mm)",
       y = "Number of Penguins")
...
boxplot <- ggplot(data = penguins_data, aes(x = species, y = flipper_length_mm, fill = species)) +
  geom_boxplot() +
  geom_jitter(size = 0.5) +
  theme_bw() +
  scale_fill_manual(values = c("darkorange", "darkorchid", "cyan4"), name = "Species Type") +
...
histogram <- ggplot(data = penguins_data, aes(x = culmen_depth_mm, fill = species)) +
  geom_histogram() +
  theme_bw() +
  scale_fill_viridis_d(option = "inferno") +
  labs(title = "Palmer Penguins' Culmen Depth",
